...
@section('content')
    <div class="container text-light py-5">
        ...
        <div class="container">
            ...
            <div class="btns px-3">
                <a href=" {{route('admin.users.edit', $user)}} " class="btn btn-outline-warning text-light"><i class="fa-solid fa-pen-to-square text-warning"></i></a>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6">
                                <div class="card-body mx-4">
                                    <h5 class="card-title text-center fw-bold fs-2">{{ $res->name_of_restaurant }}</h5>
                                    <p class="card-text">
                                        <i class="fa-solid fa-house"></i> {{ $res->address }} <br>
                                        <i class="fa-solid fa-phone"></i> {{ $res->phone_number }} <br>
                                        <i class="fa-solid fa-envelope"></i> {{ $res->email }} <br>
                                        <i class="fa-solid fa-wallet"></i> Partita IVA {{$res->p_iva}}
                                    </p>
